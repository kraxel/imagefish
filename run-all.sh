...
arm-b32 | cubietruck)
	# rebuild images
	./Fedora-rpi32.sh		28	|| exit 1
	./Fedora-efi-armv7.sh		28	|| exit 1
	;;
arm-b64)
	# rebuild images
	./Fedora-rpi64.sh		28	|| exit 1
	./Fedora-efi-grub2.sh 		28	|| exit 1
	./Fedora-efi-systemd.sh 	28	|| exit 1
	;;
sirius)
	# rebuild images
	...
	./Fedora-efi-grub2.sh		28	|| exit 1
	./Fedora-efi-systemd.sh		28	|| exit 1
	linux32 ./Fedora-efi-systemd.sh	28	|| exit 1
